...
export default function QuotationModern() {
  ...
  const generatePDF = async () => {
    try {
      ...
      let yPosition = height - 142.5; // Empezar desde arriba
      ...
      page8.drawText(`Costo por Hora: ${quotationData.configuracion.tarifaPorHora}`, {
        x: 75,
        y: yPosition,
        size: fontSize + 8,
        color: TextColor,
      ...
      quotationData.elementos.forEach((elemento, index) => {
        ...
        page8.drawText(`${index + 1}.\t${elemento.categoria}\t-\t${elemento.nombre}:\t${elemento.descripcion}`, {
          x: 90,
          y: yPosition,
          size: fontSize,
          color: TextColor,
        ...
        // yPosition -= lineHeight;
        page8.drawText(`${adminSettings.currency}${elemento.costo.toLocaleString()}`, {
          x: 1050,
          y: yPosition,
          size: fontSize,
          color: rgb(1,1,1),
        ...
        page8.drawText(`${elemento.horas}h`, {
          x: 1300,
          y: yPosition,
          size: fontSize,
          color: rgb(1,1,1),
        ...
        yPosition -= lineHeight * 1.502;
      });
      
      // Resumen final en la parte inferior
      yPosition = 172; // Posición fija para el resumen
      ...
      page8.drawText(`${adminSettings.currency}${quotationData.resumen.total.toLocaleString()}`, {
        x: 1050,
        y: yPosition,
        size: fontSize + 4,
        color: TextColor,
      ...
      // yPosition -= lineHeight;
      page8.drawText(`${quotationData.resumen.totalHoras}h/${quotationData.resumen.diasLaborales}d`, {
        x: 1270,
        y: yPosition,
        size: fontSize + 4,
        color: TextColor,
